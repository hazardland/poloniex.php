...
"   1 ".$this->to_currency.' = '.$this->buy_rate." ".$this->from_currency.' '.chr(16).' '.$this->buy_rate_next()." ".$this->from_currency."\n".
...
"   1 ".$this->to_currency.' = '.$this->sell_rate." ".$this->from_currency.' '.chr(16).' '.$this->sell_rate_next()." ".$this->from_currency."\n".
